  ...
  return (
    <div className="bg-card rounded-2xl shadow-lg border border-border p-8">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900">AI Training Platform</h1>
        <p className="text-muted mt-2">Sign in to access training materials</p>
      </div>
      ...
      <p className="text-center text-xs text-muted mt-6">
        By signing in, you agree to contribute to collaborative AI training material review.
      </p>
    </div>
  )
}
